...
export const hrms = {
    what: {
        ...
        'bulletPointsText': ['<strong>Streamlining your HR processes:</strong> It can automate many of your HR processes, such as payroll, benefits administration, and employee onboarding. This can save you time and money, and it can also help you to improve the accuracy of your data.', '<strong>Improving your employee experience:</strong> Our platform can help you to improve your employee experience by providing them with a single platform to access their HR information, such as their pay stubs, benefits, and leave requests. This can help to increase employee satisfaction and engagement.', '<strong>Complying with regulations:</strong> Our platform can help you to comply with government regulations by keeping track of employee data and ensuring that all required reports are filed on time. This can help to protect your business from legal liability.'],
